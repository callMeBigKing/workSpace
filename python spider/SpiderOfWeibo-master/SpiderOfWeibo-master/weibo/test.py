...
def main():
    username = 'ruansongsong@gmail.com'  # 微博账号nua
    pwd = '644179052'     # 微博密码
    ...
    req = urllib2.Request(url='http://s.weibo.com/weibo/%25E9%2583%2591%25E7%2588%25BD&page=2',)
    result = urllib2.urlopen(req)
    text = result.read()
    get_weibo.write_all_info(text)
